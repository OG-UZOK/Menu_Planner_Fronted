function paginationCreate(data,url,optionsCurrent,haveDeath){
    ...
    function displayList() {
        var form = document.getElementById("listOfCards");
        form.innerHTML = '';
        ...
        for (let i = 0; i < rowCount; i++) {
          ...
          for (let j = 0; j < 2 && consultationCurrent < consultationsCount; j++) {
              ...
              element.className += 'col-xxl row m-2 card';
              ...
              if (!haveDeath && inspections.hasNested == false) {
                ...
                alter.appendChild(hiddenIdElement);
                alter.className += 'col-auto detailsConsultations';
                alter.innerHTML += `🗊📝 Добавить осмотр`;
